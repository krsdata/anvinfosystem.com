...
function twentythirteen_widgets_init() {
	register_sidebar( array(
	    'name'          => __( 'Header Widget Area 1', 'twentythirteen' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Appears in the top header section of the site.', 'twentythirteen' ),
		'before_widget' => '',
		'after_widget'  => '',
    ...
    register_sidebar( array(
	    'name'          => __( 'Header Widget Area 2', 'twentythirteen' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears in the top header section of the site.', 'twentythirteen' ),
		'before_widget' => '',
		'after_widget'  => '',
    ...
    register_sidebar( array(
	    'name'          => __( 'Footer  Area', 'twentythirteen' ),
		'id'            => 'sidebar-3',
		'description'   => __( 'Appears in the top footer section of the site.', 'twentythirteen' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
    ...
    register_sidebar( array(
	    'name'          => __( 'Blog Sidebar  Area 1', 'twentythirteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears in the blog section of the site.', 'twentythirteen' ),
	 ...
	 register_sidebar( array(
	    'name'          => __( 'Blog Sidebar  Area 2', 'twentythirteen' ),
		'id'            => 'sidebar-5',
		'description'   => __( 'Appears in the blog section of the site.', 'twentythirteen' ),
		'before_widget' => '<div class="well">',
		'after_widget'  => '</div>',
     ...
     register_sidebar( array(
	    'name'          => __( 'Blog Sidebar  Area 3', 'twentythirteen' ),
		'id'            => 'sidebar-6',
		'description'   => __( 'Appears in the blog section of the site.', 'twentythirteen' ),
		'before_widget' => '<div class="well">',
		'after_widget'  => '</div>',
...
function my_add_plan() {

	if (isset( $_POST['simplepro_id'] ) || isset( $_POST['smartpro_id'] ) ) {
