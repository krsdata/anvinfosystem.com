 ...
 ?>
    ...
    <section class="content">
	  ...
	  <div class="col-xs-12">
		...
		<?php } ?>
			<!-- form -->
				 <form class="form-horizontal" method="post" action="process/process.php?action=EditRecord&id=<?php echo $row['id']; ?>">
				  <div class="form-group">
					<label class="control-label col-sm-2" for="email">Lender Name</label>
					<div class="col-sm-10">
					  <input type="text" required value="<?php echo $row['lname']; ?>" class="form-control" name="lname" placeholder="Lender Name">
					</div>
				  </div>
				  <div class="form-group">
					<label class="control-label col-sm-2" for="pwd">Borrower Name</label>
					<div class="col-sm-10">
					  <input type="text" name="bname" value="<?php echo $row['bname']; ?>" required class="form-control" placeholder="Borrower Name">
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text"  name="interest" value="<?php echo $row['interest']; ?>" required class="form-control" placeholder="Interest">
					</div>
				  </div>
				  <div class="form-group">
					<label class="control-label col-sm-2" for="pwd">Amount</label>
					<div class="col-sm-10">
					  <input type="text"  name="amount" value="<?php echo $row['amount']; ?>" required class="form-control" placeholder="Amount">
					</div>
				  </div>
				  <div class="form-group">
