...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Search By Lender</h1>
	  <form method="post" action="SearchByLender?action=ByLender" >
	  Enter Lender Name: <input placeholder="Enter Lender Name" required type="text"  name="lender"  />
	  ...
	  <div class="col-xs-12">
		...
		<?php } ?>
          ...
          <table  class="table table-bordered table-hover">
                ...
                <tbody>
				<?php
				if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'ByLender') {
				 $sql="select * from `records` where `lname` like '%".$_REQUEST['lender']."%'";
				$data=$db->query($sql);
