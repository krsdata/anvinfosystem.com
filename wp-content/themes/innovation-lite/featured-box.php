...
<div class="box90">
	<div class="featured-boxs">
		<?php  foreach (range(1, 12) as $fboxn) { if ( $fboxn == 1 ): $innovation_bi = 'fa-asterisk'; endif; if ( $fboxn == 2 ): $innovation_bi = 'fa-university'; endif;  if ( $fboxn == 3 ): $innovation_bi = 'fa-heartbeat'; endif;  if ( $fboxn == 4 ): $innovation_bi = 'fa-cog'; endif; ?>
				<span class="featured-box" >
                	<a href="<?php echo esc_url(innovation_get_option('featured-link'. $fboxn, '#')); ?>"> 
					<div>
						<img height="55" src="<?php echo esc_html(innovation_get_option('featured-icon' . $fboxn, $innovation_bi )); ?>" alt="<?php echo esc_attr(innovation_get_option('featured-title' . $fboxn, 'Innovation Lite Responsive')); ?>" class="featureImg"></div>
